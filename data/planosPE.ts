...
export const PE_PLAN: Record<string, AulaPlan[]> = {
    ...
    'ilgch': [
        ...
        { data: '03/07', tri: '2º Tri', modulo: 'Seminários', titulo: 'Apresentações: Povos Originários', destaque: true, desc: 'Apresentação de todos os grupos sobre povos das 5 regiões do Brasil.', resumo: `🎯 **Objetivo da Aula:** Socializar conhecimento sobre a cultura e concluir as apresentações avaliativas.\n\n🗣️ **Dinâmica:**\n• Apresentação de todos os grupos.\n• Fechamento e análise comparada das etnias pesquisadas.` },
        { data: '10/07', tri: '2º Tri', modulo: 'Recesso', titulo: 'Recesso Escolar', desc: 'Início das Férias/Recesso.', resumo: `🎯 **Objetivo da Aula:** Recesso escolar - Sem aula.` },
        { data: '17/07', tri: '2º Tri', modulo: 'Recesso', titulo: 'Recesso Escolar', desc: 'Recesso escolar - Sem aula.', resumo: `🎯 **Objetivo da Aula:** Recesso escolar - Sem aula.` },
        { data: '31/07', tri: '2º Tri', modulo: 'Políticas Públicas', titulo: 'A Guerra pela sua Mente: Algoritmos e Saúde Mental', desc: 'Análise de redes sociais, dopamina, tempo de tela e reterritorialização do próprio corpo.', resumo: `🎯 **Objetivo da Aula:** Compreender o impacto neuroquímico e corporal do uso de redes sociais, aprendendo estratégias práticas de decolonização do tempo e do espaço físico.\n\n🗣️ **ROTEIRO DE FALA DO PROFESSOR (PASSO A PASSO):**\n\n📢 **1. INTRODUÇÃO (Acolhimento - 5 min):**\n"Bom dia, pessoal! Hoje nós vamos falar sobre uma guerra invisível que está acontecendo agora mesmo, neste exato segundo, dentro do seu bolso. Quem aqui olhou o celular nos últimos 15 minutos? E por quê? Não é bronca! Quero que vocês pensem: vocês escolheram abri-lo ou sentiram uma 'coceira' física na mão? Hoje vamos entender a química do nosso cérebro, como as gigantes da tecnologia vendem nosso tempo e como podemos recuperar o comando."\n\n🧠 **2. A ARMADILHA DA DOPAMINA (10 min):**\n"A dopamina não é o hormônio do prazer, mas do DESEJO e da expectativa! No feed infinito (TikTok/Reels), o algoritmo funciona como uma máquina caça-níqueis. Ele intercala posts sem graça com posts sensacionais. Esse padrão incerto vicia seu cérebro e cansa sua mente. Após 20 minutos disso, sua capacidade de focar despenca. Vamos abrir agora o celular em 'Tempo de Tela' nas configurações e ver quem tem a coragem de falar o seu tempo real de uso de ontem?"\n\n🧘‍♂️ **3. CORPO IMÓVEL x CÉREBRO ACELERADO (10 min):**\n"Enquanto o cérebro voa a mil por hora, o corpo está curvado e estático. A cabeça inclinada joga um peso de até 27kg na coluna cervical (Tech Neck)! Além disso, usar o celular antes de dormir bloqueia a melatonina, gerando um cansaço crônico. A boa notícia é que esportes liberam endorfina e serotonina reais, limpando a mente. Vamos todos ficar de pé por 10 segundos, alinhar a postura, respirar fundo e sentir o alívio imediato na coluna. Sinta seu corpo de verdade!"\n\n🌐 **4. QUEM COMANDA SUA IDENTIDADE? (10 min):**\n"Se você não paga pelo produto, o produto é você: eles vendem seu tempo de vida para anunciantes. Decolonizar o feed significa retomar suas escolhas reais e o comando de sua rotina. Como hack de atenção: desativem notificações inúteis, deixem o celular longe do quarto ao dormir e pratiquem atividades físicas."\n\n🔥 **5. DEBATE EXPRESS (10 min):**\n"Vamos abrir a roda: Qual a primeira coisa que faz ao acordar e a última antes de dormir? É olhar o celular? Você sente que controla o aparelho ou ele te controla? Quero ouvir as opiniões sinceras de vocês!"\n\n✍️ **6. ATIVIDADE NO CADERNO (15 min):**\n"Mantenham as perguntas projetadas. Respondam as 4 questões individualmente. Passarei nas carteiras dando visto e nota de participação do trimestre no caderno de todos!"` },
        { data: '07/08', tri: '2º Tri', modulo: 'Mídias', titulo: 'Redes Sociais, Ativismo e Algoritmos', desc: 'Ativismo virtual x presencial. A bolha dos algoritmos.', resumo: `🎯 **Objetivo da Aula:** Entender como a internet molda o que recebemos de causa social.\n\n🗣️ **Dinâmica:**\n• Debate sobre ativismo de sofá.\n• Cancelamento nas mídias sociais.` },
        { data: '14/08', tri: '2º Tri', modulo: 'Cultura', titulo: 'Apropriação vs Intercâmbio', desc: 'A fronteira da apropriação cultural na moda, no esporte e na música.', resumo: `🎯 **Objetivo da Aula:** Destrinchar de quem é a arte e por qual preço se adquire.\n\n🗣️ **Dinâmica:**\n• Elementos tradicionais que viraram produtos comerciais.\n• Respeito e herança.` },
        { data: '21/08', tri: '2º Tri', modulo: 'Revisão', titulo: 'Revisão Geral e Plantão', desc: 'Repasse completo pro trimestre (Racismo, Autodeclaração, Krenak, Políticas Públicas).', resumo: `🎯 **Objetivo da Aula:** Sistematização de saberes (Povos Originários, Lutas Sociais, Identidade).` },
        { data: '28/08', tri: '2º Tri', modulo: 'Avaliação', titulo: 'Avaliação Teórica', desc: 'Prova final do Itinerário Formativo sobre Ciências Humanas.', resumo: `🎯 **Objetivo da Aula:** Verificar o amadurecimento crítico do aluno.` },
        { data: '04/09', tri: '2º Tri', modulo: 'Recuperação', titulo: 'Recuperação e 2ª Chamada', desc: 'Consolidação de notas e oportunidade para reavaliação.', resumo: `🎯 **Objetivo da Aula:** Recuperação de notas dos alunos que não alcançaram a média.` },
        { data: '11/09', tri: '3º Tri', modulo: 'Gênero e Esporte', titulo: 'Gênero, Sociedade e Esporte', desc: 'Início do conteúdo trimestral novo. Evolução dos papéis das mulheres na cena esportiva.', resumo: `🎯 **Objetivo da Aula:** Questionar a divisão de esporte de 'menino' e de 'menina'.\n\n🗣️ **Dinâmica:**\n• Aula expositiva abrindo as próximas rodas de debate do ano.` },
        { data: '18/09', tri: '3º Tri', modulo: 'Gênero e Ciência', titulo: 'O Apagamento Invisível', desc: 'Apagamento histórico de mulheres na ciência.', resumo: `🎯 **Objetivo da Aula:** Discutir a exclusão histórica de corpos femininos do ecossistema científico.\n\n🗣️ **Dinâmica:**\n• O "Efeito Matilda".\n• Discussão sobre desigualdade estrutural de gênero no meio acadêmico.\n\n📜 **Reflexão:** De quem são as patentes e glórias das grandes inovações humanas?` },
        { data: '25/09', tri: '3º Tri', modulo: 'Gênero e Esporte', titulo: 'Divisão Sexista do Corpo', desc: 'Preconceitos em torno do esporte.', resumo: `🎯 **Objetivo da Aula:** Desconstruir rótulos que delimitam as práticas esportivas legítimas para cada gênero.\n\n🗣️ **Dinâmica:**\n• Por que modalidades olímpicas eram proibidas para mulheres?\n• O preconceito com corpos femininos atléticos.\n\n📜 **Reflexão:** Prática corporal tem gênero?` },
        { data: '02/10', tri: '3º Tri', modulo: 'Trabalho Acadêmico', titulo: 'Pioneiras da Mudança', desc: 'Passagem do trabalho.', trabalho: 'passar', resumo: `🎯 **Objetivo da Aula:** Definir os parâmetros e temas das apresentações finais.\n\n🗣️ **Dinâmica:**\n• Divisão dos grupos (de até 5 alunos).\n• Escolha do tema: Pioneira (ciência, filosofia ou esporte).\n\n⚠️ **TRABALHO:** Pesquisa profunda sobre uma pioneira em sua área. (Grupos 1, 2 e 3 apresentam no dia 30/10; 4 e 5 no dia 06/11).` },
        { data: '09/10', tri: '3º Tri', modulo: 'Gênero e Mídia', titulo: 'Hipersexualização e Espetáculo', desc: 'Representação visual nas mídias.', resumo: `🎯 **Objetivo da Aula:** Desenvolver olhar crítico sobre as mídias esportivas e de entretenimento.\n\n🗣️ **Dinâmica:**\n• Análise de coberturas jornalísticas (foco nos trajes vs técnica).\n• A imposição comercial de padrões estéticos absurdos.\n\n📜 **Reflexão:** O esporte feminino é consumido pela técnica ou pelo apelo puramente estético?` },
        { data: '16/10', tri: '3º Tri', modulo: 'Direitos e Igualdade', titulo: 'Equidade Salarial no Esporte', desc: 'Disparidade de investimentos e patrocínio.', resumo: `🎯 **Objetivo da Aula:** Discutir economia e direitos de arena.\n\n🗣️ **Dinâmica:**\n• Comparação salarial e infraestrutura de federações.\n• Luta global por premiações idênticas.\n\n📜 **Reflexão:** Por que marcas pagam menos por visualização de torneios femininos?` },
        { data: '23/10', tri: '3º Tri', modulo: 'Gênero e História', titulo: 'As Pioneiras Olímpicas', desc: 'O legado de Maria Lenk, Aída dos Santos.', resumo: `🎯 **Objetivo da Aula:** Reconhecer a história do desporto nacional feminino.\n\n🗣️ **Dinâmica:**\n• Apresentação do legado de Aída dos Santos e Maria Lenk.\n• A proibição oficial do esporte para mulheres no Brasil (Vargas).\n\n📜 **Reflexão:** Qual o preço que as primeiras mulheres brasileiras pagaram?` },
        { data: '30/10', tri: '3º Tri', modulo: 'Seminários', titulo: 'Apre: Pioneiras (P1)', destaque: true, desc: 'Apresentação dos grupos 1, 2 e 3.', resumo: `🎯 **Objetivo da Aula:** Desenvolver raciocínio crítico coletivo.\n\n🗣️ **Dinâmica:**\n• Apresentação visual e oral dos 3 primeiros grupos.\n• Debate mediado pelo professor.` },
        { data: '06/11', tri: '3º Tri', modulo: 'Seminários', titulo: 'Apre: Pioneiras (P2)', destaque: true, desc: 'Apresentação dos grupos 4 e 5.', resumo: `🎯 **Objetivo da Aula:** Concluir os seminários avaliativos.\n\n🗣️ **Dinâmica:**\n• Apresentação dos grupos 4 e 5.\n• Síntese integrativa.` },
        { data: '13/11', tri: '3º Tri', modulo: 'Integração', titulo: 'Debate Integrador', desc: 'Consolidação das discussões de gênero do ano.', resumo: `🎯 **Objetivo da Aula:** Consolidar aprendizados sobre Gênero, Ciência e Esporte.\n\n🗣️ **Dinâmica:**\n• Roda de debate final sobre os principais pontos discutidos no trimestre.` },
        { data: '27/11', tri: '3º Tri', modulo: 'Integração', titulo: 'Síntese Final: Disciplina', desc: 'Review dos eixos ILGCH do ano.', resumo: `🎯 **Objetivo da Aula:** Visão geral do percurso formativo da disciplina.\n\n🗣️ **Dinâmica:**\n• Revisão temática.\n• Feedback coletivo.` },
        { data: '04/12', tri: '3º Tri', modulo: 'Avaliação', titulo: 'Avaliação Final', desc: 'Avaliação conceitual escrita.', resumo: `🎯 **Objetivo da Aula:** Verificação crítica de saberes do ano letivo.\n\n🗣️ **Dinâmica:**\n• Prova escrita analítica.` },
        { data: '11/12', tri: '3º Tri', modulo: 'Recuperação', titulo: 'Recuperação Final', desc: 'Fechamento de diários e notas.', resumo: `🎯 **Objetivo da Aula:** Fechamento final e recuperação paralela.` }
